...
void GUIView::drawCustMap() {
    ...
    gui::draw::drawMenuButton(am, "< Back", gui::draw::centeredRect(cx - W * 0.20f, H * 0.10f, 140.f, 52.f),
                              hoveredItem_ == 30, false);
...
bool GUIView::handleMapCustomizeInput() {
    ...
    const float startX = cx - gridW * 0.5f + btnW * 0.5f;
    const float startY = cy - H * 0.12f;
    const Rectangle backRect = gui::draw::centeredRect(cx - W * 0.20f, H * 0.10f, 140.f, 52.f);
