...
public:
    ...
    AbilityCardDeck(const AbilityCardDeck& other) = delete;
    AbilityCardDeck& operator=(const AbilityCardDeck& other) = delete;

    AbilityCardDeck(AbilityCardDeck&& other) noexcept = default;
    AbilityCardDeck& operator=(AbilityCardDeck&& other) noexcept = default;
};